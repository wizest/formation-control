...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
 const mxArray * prhs[] )
{
  extern unsigned int sf_multiAgents4_process_check_sum_call( int nlhs, mxArray
   * plhs[], int nrhs, const mxArray * prhs[] );

  if(sf_multiAgents4_process_check_sum_call(nlhs,plhs,nrhs,prhs)) return 1;
  return 0;
}
unsigned int sf_process_autoinheritence_call( int nlhs, mxArray * plhs[], int
 nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_multiAgents4_autoinheritance_info( int nlhs, mxArray *
   plhs[], int nrhs, const mxArray * prhs[] );
  if(sf_multiAgents4_autoinheritance_info(nlhs,plhs,nrhs,prhs)) return 1;
  return 0;
}
unsigned int sf_process_get_eml_resolved_functions_info_call( int nlhs, mxArray
 * plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_multiAgents4_get_eml_resolved_functions_info( int nlhs,
  ...
  if(strcmp(machineName, "multiAgents4") == 0) {
    const mxArray *newRhs[2] = { NULL, NULL };
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_multiAgents4_get_eml_resolved_functions_info(nlhs,plhs,2,newRhs);
  }
...
extern unsigned int sf_multiAgents4_method_dispatcher(SimStruct *S, unsigned int
...
{
  if(!strcmp(machineName,"multiAgents4")) {
    return(sf_multiAgents4_method_dispatcher(simstructPtr,chartFileNumber,method,data));
  }
  return 0;
}
extern void multiAgents4_terminator(void);
void sf_machine_global_terminator(void)
{
  if(sfMachineGlobalTerminatorCallable) {
    ...
    multiAgents4_terminator();
    sf_debug_terminate();
  }
  return;
}
extern void multiAgents4_initializer(void);
extern void multiAgents4_register_exported_symbols(SimStruct* S);
extern void multiAgents4_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  multiAgents4_register_exported_symbols(S);
}
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if(sfMachineGlobalInitializerCallable) {
    ...
    if(!simModeIsRTWGen) {
      multiAgents4_debug_initialize();
    }
    multiAgents4_initializer();
  }
  return;
}
