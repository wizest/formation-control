...
static SFc2_multiAgents4InstanceStruct chartInstance;

/* Function Declarations */
static void initialize_c2_multiAgents4(void);
static void initialize_params_c2_multiAgents4(void);
static void enable_c2_multiAgents4(void);
static void disable_c2_multiAgents4(void);
static void finalize_c2_multiAgents4(void);
static void sf_c2_multiAgents4(void);
...
static void initialize_c2_multiAgents4(void)
{
  ...
  chartInstance.c2_is_active_c2_multiAgents4 = 0U;
}
...
const mxArray *sf_c2_multiAgents4_get_eml_resolved_functions_info(void)
{
...
static void c2_info_helper(c2_ResolvedFunctionInfo c2_info[21])
{
  ...
  c2_info[1].name = "isfloat";
  c2_info[1].dominantType = "double";
  c2_info[1].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isfloat.m";
  c2_info[1].fileLength = 182U;
  c2_info[1].fileTime1 = 1160399820U;
  c2_info[1].fileTime2 = 0U;
  c2_info[2].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/sin.m";
  c2_info[2].name = "isscalar";
  c2_info[2].dominantType = "double";
  c2_info[2].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isscalar.m";
  c2_info[2].fileLength = 243U;
  c2_info[2].fileTime1 = 1160399904U;
  ...
  c2_info[4].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  c2_info[4].name = "size";
  ...
  c2_info[5].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/sin.m";
  ...
  c2_info[6].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/sin.m";
  c2_info[6].fileLength = 769U;
  c2_info[6].fileTime1 = 1163920354U;
  ...
  c2_info[8].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isa.m";
  c2_info[8].fileLength = 791U;
  c2_info[8].fileTime1 = 1160399818U;
  ...
  c2_info[10].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_numel.m";
  c2_info[10].name = "numel";
  c2_info[10].dominantType = "double";
  c2_info[10].resolved = "[B]numel";
  ...
  c2_info[11].fileLength = 273U;
  c2_info[11].fileTime1 = 1160399944U;
  ...
  c2_info[14].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  c2_info[14].fileLength = 347U;
  c2_info[14].fileTime1 = 1163920370U;
  ...
  c2_info[18].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isa.m";
  c2_info[18].name = "eq";
...
/* SFunction Glue Code */
void sf_c2_multiAgents4_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_multiAgents4_get_autoinheritance_info(void)
{
...
static void sf_opaque_initialize_c2_multiAgents4(void *chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S,0);
  initialize_params_c2_multiAgents4();
  initialize_c2_multiAgents4();
}

static void sf_opaque_enable_c2_multiAgents4(void *chartInstanceVar)
{
  enable_c2_multiAgents4();
}

static void sf_opaque_disable_c2_multiAgents4(void *chartInstanceVar)
{
  disable_c2_multiAgents4();
}

static void sf_opaque_gateway_c2_multiAgents4(void *chartInstanceVar)
{
  sf_c2_multiAgents4();
}

static void sf_opaque_terminate_c2_multiAgents4(void *chartInstanceVar)
{
  if (sim_mode_is_rtw_gen(chartInstance.S) ||
   sim_mode_is_external(chartInstance.S)) {
    sf_clear_rtw_identifier(chartInstance.S);
  }
  finalize_c2_multiAgents4();
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_multiAgents4(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_multiAgents4(SimStruct *S)
{
  if(sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("multiAgents4",2);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop("multiAgents4",2,"gatewayCannotBeInlinedMultipleTimes"));
    if(chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"multiAgents4",2,1);
      sf_mark_chart_reusable_outputs(S,"multiAgents4",2,1);
    }
    sf_set_rtw_dwork_info(S,"multiAgents4",2);
...
static void mdlRTW_c2_multiAgents4(SimStruct *S)
{
  if(sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "multiAgents4", 2);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c2_multiAgents4(SimStruct *S)
{
  chartInstance.chartInfo.chartInstance = NULL;
  chartInstance.chartInfo.isEMLChart = 1;
  chartInstance.chartInfo.chartInitialized = 0;
  chartInstance.chartInfo.sFunctionGateway = sf_opaque_gateway_c2_multiAgents4;
  chartInstance.chartInfo.initializeChart = sf_opaque_initialize_c2_multiAgents4;
  chartInstance.chartInfo.terminateChart = sf_opaque_terminate_c2_multiAgents4;
  chartInstance.chartInfo.enableChart = sf_opaque_enable_c2_multiAgents4;
  chartInstance.chartInfo.disableChart = sf_opaque_disable_c2_multiAgents4;
  chartInstance.chartInfo.zeroCrossings = NULL;
  chartInstance.chartInfo.outputs = NULL;
  chartInstance.chartInfo.derivatives = NULL;
  chartInstance.chartInfo.mdlRTW = mdlRTW_c2_multiAgents4;
  chartInstance.chartInfo.mdlStart = mdlStart_c2_multiAgents4;
  chartInstance.chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_multiAgents4;
...
void c2_multiAgents4_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_multiAgents4(S);
    break;
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_multiAgents4(S);
    break;
   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_multiAgents4(S);
    break;
   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
     "Error calling c2_multiAgents4_method_dispatcher.\n"
